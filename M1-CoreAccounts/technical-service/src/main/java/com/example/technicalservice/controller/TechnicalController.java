...
public class TechnicalController {
    ...
    public ResponseEntity<String> unlockAccountFunds(@PathVariable String accountNumber,
            @RequestBody Map<String, BigDecimal> request) {
        technicalFunctionService.unlockAccountFunds(accountNumber, request.get("amount"));
        return ResponseEntity.ok("Funds unlocked");
    }
}
